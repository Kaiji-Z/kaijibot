---
summary: "First-run setup flow for KaijiBot (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give KaijiBot">
...
<Step title="CLI">
  ...
  The app can install the global `kaijibot` CLI via npm, pnpm, or bun.
