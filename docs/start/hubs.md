---
summary: "Hubs that link to every KaijiBot doc"
read_when:
...
<Note>
If you are new to KaijiBot, start with [Getting Started](/start/getting-started).
</Note>
...
- [KaijiBot assistant](/start/kaijibot)
