...
If the active memory plugin exposes shared recall artifacts, KaijiBot can search
...
kaijibot wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
