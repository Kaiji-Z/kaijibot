...
KaijiBot also runs a separate idempotent cleanup for older legacy sessions that
...
KaijiBot auto-enables pruning for Anthropic profiles:
...
If you set explicit values, KaijiBot does not override them.
