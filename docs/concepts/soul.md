---
summary: "Use SOUL.md to give your KaijiBot agent an actual voice instead of generic assistant sludge"
read_when:
...
KaijiBot injects it on normal sessions, so it has real weight. If your agent
...
For KaijiBot, `SOUL.md` is that layer.
...
Path fixed for KaijiBot workspaces: use `SOUL.md`, not `http://SOUL.md`.
