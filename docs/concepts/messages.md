...
Channels can redeliver the same message after reconnects. KaijiBot keeps a
...
KaijiBot separates the **prompt body** from the **command body**:
...
KaijiBot can expose or hide model reasoning:
