---
summary: "Use NVIDIA's OpenAI-compatible API in KaijiBot"
read_when:
  - You want to use open models in KaijiBot for free
...
kaijibot onboard --auth-choice skip
kaijibot models set nvidia/nvidia/nemotron-3-super-120b-a12b
```
