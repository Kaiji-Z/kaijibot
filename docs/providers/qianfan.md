---
summary: "Use Qianfan's unified API to access many models in KaijiBot"
read_when:
...
3. KaijiBot installed on your system
...
4. Copy the API key for use with KaijiBot

## CLI setup

```bash
kaijibot onboard --auth-choice qianfan-api-key
```
...
- [KaijiBot Configuration](/gateway/configuration)
