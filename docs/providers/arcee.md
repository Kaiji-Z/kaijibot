...
read_when:
  - You want to use Arcee AI with KaijiBot
...
kaijibot onboard --auth-choice arceeai-api-key

# Via OpenRouter
kaijibot onboard --auth-choice arceeai-openrouter
```
...
KaijiBot currently ships this bundled Arcee catalog:
