---
summary: "Use Mistral models and Voxtral transcription with KaijiBot"
read_when:
  - You want to use Mistral models in KaijiBot
...
KaijiBot supports Mistral for both text/image model routing (`mistral/...`) and
...
```bash
kaijibot onboard --auth-choice mistral-api-key
# or non-interactive
kaijibot onboard --mistral-api-key "$MISTRAL_API_KEY"
```
...
KaijiBot currently ships this bundled Mistral catalog:
...
KaijiBot maps the session **thinking** level to Mistral’s API:
