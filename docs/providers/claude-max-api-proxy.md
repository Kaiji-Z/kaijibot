...
You can point KaijiBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or KaijiBot
...
- [Anthropic provider](/providers/anthropic) - Native KaijiBot integration with Claude CLI or API keys
