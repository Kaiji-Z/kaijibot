...
type WebFetchConfig = NonNullable<KaijiBotConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(config: KaijiBotConfig | undefined): WebFetchConfig | undefined {
