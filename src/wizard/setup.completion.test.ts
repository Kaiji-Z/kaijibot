...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("kaijibot");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "kaijibot");
