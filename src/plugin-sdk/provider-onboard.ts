...
export type { KaijiBotConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: KaijiBotConfig, ...args: TArgs) => KaijiBotConfig;
  applyConfig: (cfg: KaijiBotConfig, ...args: TArgs) => KaijiBotConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: KaijiBotConfig, preset: TParams) => KaijiBotConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: KaijiBotConfig): {
  next: KaijiBotConfig;
  changed: boolean;
} {
