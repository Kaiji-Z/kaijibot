...
function buildNoVideoGenerationModelConfiguredMessage(cfg: KaijiBotConfig): string {
...
export function listRuntimeVideoGenerationProviders(params?: { config?: KaijiBotConfig }) {
