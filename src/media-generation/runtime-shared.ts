...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: KaijiBotConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: KaijiBotConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: KaijiBotConfig;
  agentDir?: string;
  listProviders: (cfg?: KaijiBotConfig) => CapabilityProviderCandidate[];
}): string[] {
