/**
 * Hook system for KaijiBot agent events
 *
...
export type InternalHookEventType = "command" | "session" | "agent" | "gateway" | "message" | "compaction";
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("kaijibot.internalHookHandlers");
