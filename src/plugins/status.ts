...
import { normalizeKaijiBotVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeKaijiBotVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeKaijiBotVersionBase(plugin.version) ??
    plugin.version
  );
}
