...
const originalBundledDir = process.env.KAIJIBOT_BUNDLED_PLUGINS_DIR;
const originalDisableBundledPlugins = process.env.KAIJIBOT_DISABLE_BUNDLED_PLUGINS;
...
function createKaijiBotRoot(params: {
  prefix: string;
  ...
  fs.writeFileSync(
    ...
    `${JSON.stringify({ name: "kaijibot" }, null, 2)}\n`,
    "utf8",
  );
  return repoRoot;
}
...
function seedBundledPluginTree(rootDir: string, relativeDir: string, pluginId = "discord") {
  ...
  fs.writeFileSync(
    ...
    `${JSON.stringify({ name: `@kaijibot/${pluginId}` }, null, 2)}\n`,
    "utf8",
  );
  fs.writeFileSync(
...
function expectResolvedBundledDir(params: {
  ...
  if (params.bundledDirOverride === undefined) {
    ...
    process.env.KAIJIBOT_BUNDLED_PLUGINS_DIR = params.bundledDirOverride;
  }
  if (params.disableBundledPlugins === undefined) {
    delete process.env.KAIJIBOT_DISABLE_BUNDLED_PLUGINS;
  } else {
    process.env.KAIJIBOT_DISABLE_BUNDLED_PLUGINS = params.disableBundledPlugins;
  }
...
afterEach(() => {
  ...
  if (originalBundledDir === undefined) {
    ...
    process.env.KAIJIBOT_BUNDLED_PLUGINS_DIR = originalBundledDir;
  }
  if (originalDisableBundledPlugins === undefined) {
    delete process.env.KAIJIBOT_DISABLE_BUNDLED_PLUGINS;
  } else {
    process.env.KAIJIBOT_DISABLE_BUNDLED_PLUGINS = originalDisableBundledPlugins;
  }
...
describe("resolveBundledPluginsDir", () => {
  it.each([
    [
      ...
      {
        prefix: "kaijibot-bundled-dir-runtime-",
    ...
    [
      ...
      {
        prefix: "kaijibot-bundled-dir-dist-",
        hasDistExtensions: true,
      },
      {
        expectedRelativeDir: path.join("dist", "extensions"),
    ...
    [
      ...
      {
        prefix: "kaijibot-bundled-dir-git-built-",
        hasExtensions: true,
        hasSrc: true,
        hasDistRuntimeExtensions: true,
        hasDistExtensions: true,
    ...
    [
      ...
      {
        prefix: "kaijibot-bundled-dir-vitest-",
        hasExtensions: true,
        hasDistRuntimeExtensions: true,
        hasDistExtensions: true,
      },
    ...
    [
      ...
      {
        prefix: "kaijibot-bundled-dir-tsx-",
        hasExtensions: true,
        hasSrc: true,
        hasDistRuntimeExtensions: true,
        hasDistExtensions: true,
    ...
    [
      ...
      {
        prefix: "kaijibot-bundled-dir-git-",
        hasExtensions: true,
        hasSrc: true,
        hasGitCheckout: true,
      },
    ...
    const repoRoot = createKaijiBotRoot(layout);
  ...
  it("falls back to source extensions when dist trees exist but do not contain real plugin manifests", () => {
    const repoRoot = createKaijiBotRoot({
      prefix: "kaijibot-bundled-dir-incomplete-built-",
      hasExtensions: true,
      hasSrc: true,
      hasDistRuntimeExtensions: true,
      hasDistExtensions: true,
  ...
  it("returns a stable empty bundled plugin directory when bundled plugins are disabled", () => {
    const repoRoot = createKaijiBotRoot({
      prefix: "kaijibot-bundled-dir-disabled-",
      hasExtensions: true,
      hasSrc: true,
      hasGitCheckout: true,
    });
    ...
    process.env.KAIJIBOT_DISABLE_BUNDLED_PLUGINS = "1";
    delete process.env.KAIJIBOT_BUNDLED_PLUGINS_DIR;
  ...
  it.each([
    {
      ...
      createScenario: () => {
        const installedRoot = createKaijiBotRoot({
          prefix: "kaijibot-bundled-dir-installed-",
          hasDistExtensions: true,
        });
        seedBundledPluginTree(installedRoot, path.join("dist", "extensions"));
        const cwdRepoRoot = createKaijiBotRoot({
          prefix: "kaijibot-bundled-dir-cwd-",
          hasExtensions: true,
          hasSrc: true,
          hasGitCheckout: true,
        });
        return {
          installedRoot,
          cwd: cwdRepoRoot,
          argv1: path.join(installedRoot, "kaijibot.mjs"),
        };
      },
    },
    {
      ...
      createScenario: () => {
        const installedRoot = createKaijiBotRoot({
          prefix: "kaijibot-bundled-dir-override-",
          hasDistExtensions: true,
        });
        seedBundledPluginTree(installedRoot, path.join("dist", "extensions"));
        return {
