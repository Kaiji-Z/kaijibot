...
import type { PluginConfigUiHint, KaijiBotPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: KaijiBotPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): KaijiBotPluginConfigSchema {
  return {
