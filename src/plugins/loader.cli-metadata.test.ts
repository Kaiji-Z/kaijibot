...
import { loadKaijiBotPluginCliRegistry, loadKaijiBotPlugins } from "./loader.js";
import {
...
describe("plugin loader CLI metadata", () => {
  ...
  register(api) {
    ...
    const registry = await loadKaijiBotPluginCliRegistry({
      env: { ...process.env, KAIJIBOT_STATE_DIR: stateDir },
      logger: {
        info: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@kaijibot/cli-metadata-channel",
          kaijibot: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    process.env.KAIJIBOT_BUNDLED_PLUGINS_DIR = bundledRoot;

    fs.writeFileSync(
      path.join(pluginDir, "package.json"),
      JSON.stringify(
        {
          name: "@kaijibot/bundled-skip-channel",
          kaijibot: { extensions: ["./index.cjs"] },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@kaijibot/bundled-cli-channel",
          kaijibot: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@kaijibot/bundled-skip-provider",
          kaijibot: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@kaijibot/full-cli-metadata-channel",
          kaijibot: { extensions: ["./index.cjs"] },
        },
        null,
        2,
