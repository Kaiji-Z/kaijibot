...
import type { KaijiBotPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = KaijiBotPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("kaijibot.pluginCommandsState");
