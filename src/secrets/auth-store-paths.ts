...
export function listAuthProfileStorePaths(config: KaijiBotConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: KaijiBotConfig, stateDir: string): string[] {
