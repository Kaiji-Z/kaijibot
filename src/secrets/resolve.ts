...
function resolveResolutionLimits(config: KaijiBotConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: KaijiBotConfig): SecretProviderConfig {
