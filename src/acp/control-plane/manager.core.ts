...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: KaijiBotConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: KaijiBotConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: KaijiBotConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: KaijiBotConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: KaijiBotConfig }): Promise<void> {
