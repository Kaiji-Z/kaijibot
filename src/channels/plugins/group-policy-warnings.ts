...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: KaijiBotConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: KaijiBotConfig }>(
  collector: WarningCollector<{ cfg: KaijiBotConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: KaijiBotConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: KaijiBotConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: KaijiBotConfig },
>(
  projectCfg: (cfg: KaijiBotConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: KaijiBotConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: KaijiBotConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: KaijiBotConfig },
>(params: {
  providerConfigPresent: (cfg: KaijiBotConfig) => boolean;
