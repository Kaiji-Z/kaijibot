...
export function listChannelMessageActions(cfg: KaijiBotConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: KaijiBotConfig): ChannelMessageCapability[] {
