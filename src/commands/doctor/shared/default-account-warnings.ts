...
export function collectMissingDefaultAccountBindingWarnings(cfg: KaijiBotConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: KaijiBotConfig): string[] {
  const warnings: string[] = [];
