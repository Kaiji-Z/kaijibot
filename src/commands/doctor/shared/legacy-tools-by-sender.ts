...
export function scanLegacyToolsBySenderKeys(cfg: KaijiBotConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: KaijiBotConfig): {
