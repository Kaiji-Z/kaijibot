...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("kaijibot tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("kaijibot tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: KaijiBotConfig) {
