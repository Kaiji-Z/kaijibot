...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set KAIJIBOT_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `kaijibot dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control KaijiBot.");
  } else if (hint) {
    runtime.log(hint);
  }
}
