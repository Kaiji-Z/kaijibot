...
export function extractFromMessage(
  ...
  // Domain detection is handled by LLM extraction (llm-extractor.ts).
  // The rule-based fallback returns no domains — typedInsights remain
  // empty until the LLM pipeline fills them.
