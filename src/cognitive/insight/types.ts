...
export type InsightEngineInput = {
  ...
  /** SOUL.md personality content prepended to insight prompts; loaded from soul preset or workspace SOUL.md. */
  soulContent?: string;
  /** Identity context (IDENTITY.md + USER.md) prepended to insight prompts. */
  identityContext?: string;
  /** Recently used emotional stance indices — selector avoids repeating these. */
  recentEmotionalStances?: number[];
};
