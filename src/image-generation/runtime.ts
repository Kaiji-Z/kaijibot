...
function buildNoImageGenerationModelConfiguredMessage(cfg: KaijiBotConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: KaijiBotConfig }) {
