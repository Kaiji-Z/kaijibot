...
async function resolveContext(config: KaijiBotConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): KaijiBotConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
