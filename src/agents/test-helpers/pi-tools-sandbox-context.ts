...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "kaijibot-sbx-test",
    runtimeLabel: params.containerName ?? "kaijibot-sbx-test",
    containerName: params.containerName ?? "kaijibot-sbx-test",
