...
import { resolveKaijiBotPluginToolInputs } from "./kaijibot-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("kaijibot plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveKaijiBotPluginToolInputs({
      options: {
        config: {} as never,
