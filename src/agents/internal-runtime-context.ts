export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_KAIJIBOT_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_KAIJIBOT_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[KAIJIBOT_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[KAIJIBOT_INTERNAL_CONTEXT_END]]";
