...
import { generateSummary as piGenerateSummary } from "@earendil-works/pi-coding-agent";
...
const MERGE_SUMMARIES_INSTRUCTIONS = [
  ...
  "- User's core interests, ongoing concerns, and active exploration topics",
  "- Cross-domain connections the user has explored",
