...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<KaijiBotConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<KaijiBotConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: KaijiBotConfig): WebSearchConfig {
