...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "kaijibot:bootstrap-context:full";

export function resolveContextInjectionMode(config?: KaijiBotConfig): AgentContextInjection {
