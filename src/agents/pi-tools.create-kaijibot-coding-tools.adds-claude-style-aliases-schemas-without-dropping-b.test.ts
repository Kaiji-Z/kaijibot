...
const defaultTools = createKaijiBotCodingTools({ senderIsOwner: true });

describe("createKaijiBotCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const disabledOpenAiTools = createKaijiBotCodingTools({
    ...
    const anthropicTools = createKaijiBotCodingTools({
      config: disabledConfig,
    ...
    const allowModelsConfig: KaijiBotConfig = {
      tools: {
        exec: {
    ...
    const allowed = createKaijiBotCodingTools({
    ...
    const denied = createKaijiBotCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
    ...
    const oauthTools = createKaijiBotCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
