...
export const DEFAULT_SANDBOX_IMAGE = "kaijibot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "kaijibot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "kaijibot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "kaijibot-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "kaijibot-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "kaijibot-sandbox-browser";
