...
function buildCapabilitiesSection(params: { isMinimal: boolean }): string[] {
  ...
  return [
    ...
    "- **PRISM Gate** — Cost-sensitive gating (signal detection theory): only reaches out when expected value (pNeed × pAccept) exceeds打扰成本, with time-of-day and trust-phase hard rules",
