...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("kaijibot.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("kaijibot.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: KaijiBotConfig): Promise<ContextEngine> {
