...
import { serveKaijiBotChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage KaijiBot MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose KaijiBot channels over MCP stdio")
