...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: KaijiBotConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: KaijiBotConfig, mode: ChannelAuthMode): string {
