...
import type { CognitiveConfig } from "./types.cognitive.js";
...
export type KaijiBotConfig = {
  meta?: {
    /** Last KaijiBot version that wrote this config. */
  ...
  ui?: {
    /** Accent color for KaijiBot UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const kaijiBotConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = KaijiBotConfig & {
  readonly [kaijiBotConfigStateBrand]?: TState;
};
