...
export const FIELD_LABELS: Record<string, string> = {
  ...
  cognitive: "认知系统",
  "cognitive.enabled": "启用认知系统",
  "cognitive.proactive": "主动推送",
  "cognitive.proactive.enabled": "启用主动推送",
  "cognitive.proactive.minIntervalHours": "最小推送间隔（小时）",
  "cognitive.proactive.activeHours": "活跃时段",
  "cognitive.proactive.activeHours.start": "活跃开始时间",
  "cognitive.proactive.activeHours.end": "活跃结束时间",
  "cognitive.proactive.activeHours.timezone": "时区",
  "cognitive.proactive.digestMode": "推送摘要模式",
  "cognitive.proactive.costFalseNegative": "漏推代价（C_FN）",
  "cognitive.proactive.costFalseAlarm": "误推代价（C_FA）",
  "cognitive.persona": "用户画像",
  "cognitive.persona.autoExtract": "自动提取画像",
  "cognitive.persona.extractionModel": "画像提取模型",
  "cognitive.persona.identityRefreshHours": "画像刷新间隔（小时）",
  "cognitive.insight": "洞察生成",
  "cognitive.insight.sources": "洞察来源",
  "cognitive.insight.sources.webSearchProvider": "网页搜索提供商",
  "cognitive.insight.sources.scanIntervalHours": "信息扫描间隔（小时）",
  "cognitive.insight.sources.explicitTopics": "指定关注话题",
  "cognitive.insight.verificationLevel": "验证级别",
  "cognitive.insight.inferenceModel": "推断模型",
  "cognitive.insight.surpriseRatio": "意外推断比例",
  "cognitive.insight.outputLanguage": "输出语言",
  "cognitive.feedback": "反馈收集",
  "cognitive.feedback.mechanism": "反馈方式",
  "cognitive.feedback.implicitFeedback": "隐式反馈",
  "cognitive.evolution": "自进化",
  "cognitive.evolution.enabled": "启用自进化",
  "cognitive.evolution.minComplexity": "最低复杂度阈值",
  "cognitive.evolution.errorComplexityThreshold": "出错任务阈值",
  "cognitive.evolution.cooldownHours": "冷却时间（小时）",
  "cognitive.evolution.maxSuggestionsPerDay": "每日最大建议数",
  "cognitive.evolution.clawhubEnabled": "启用 ClawHub 分享",
  "cognitive.evolution.clawhubRegistry": "ClawHub 注册表地址",
  "cognitive.evolution.clawhubAutoPublish": "自动发布到 ClawHub",
};
