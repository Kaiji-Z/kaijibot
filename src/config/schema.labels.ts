...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "cognitive.enabled": "Cognitive Layer Enabled",
  "cognitive.proactive": "Proactive Insights",
  "cognitive.proactive.enabled": "Proactive Push Enabled",
  "cognitive.proactive.minIntervalHours": "Proactive Min Interval (hours)",
  "cognitive.proactive.activeHours": "Proactive Active Hours",
  "cognitive.proactive.activeHours.start": "Active Hours Start",
  "cognitive.proactive.activeHours.end": "Active Hours End",
  "cognitive.proactive.activeHours.timezone": "Active Hours Timezone",
  "cognitive.proactive.digestMode": "Proactive Digest Mode",
  "cognitive.proactive.costFalseAlarm": "PRISM False Alarm Cost",
  "cognitive.proactive.costFalseNegative": "PRISM False Negative Cost",
  "cognitive.proactive.maxDailyInsights": "Max Daily Insights",
  "cognitive.persona": "Persona Model",
  "cognitive.persona.autoExtract": "Persona Auto Extract",
  "cognitive.persona.extractionModel": "Persona Extraction Model",
  "cognitive.persona.identityRefreshHours": "Persona Identity Refresh (hours)",
  "cognitive.insight": "Insight Engine",
  "cognitive.insight.inferenceModel": "Insight Inference Model",
  "cognitive.insight.outputLanguage": "Insight Output Language",
  "cognitive.insight.verificationLevel": "Insight Verification Level",
  "cognitive.insight.sources": "Insight Sources",
  "cognitive.insight.sources.webSearchProvider": "Insight Web Search Provider",
  "cognitive.insight.sources.scanIntervalHours": "Insight Scan Interval (hours)",
  "cognitive.insight.sources.explicitTopics": "Insight Explicit Topics",
  "cognitive.evolution": "Skill Evolution",
  "cognitive.evolution.enabled": "Skill Evolution Enabled",
  "cognitive.evolution.cooldownHours": "Evolution Cooldown (hours)",
  "cognitive.evolution.maxSuggestionsPerDay": "Evolution Max Suggestions/Day",
  "cognitive.feedback": "Feedback (Reserved)",
  "cognitive.feedback.mechanism": "Feedback Mechanism (Reserved)",
  "cognitive.feedback.implicitFeedback": "Implicit Feedback",
  secrets: "Secrets Management",
  "secrets.providers": "Secret Providers",
  "secrets.providers.*.source": "Secret Provider Source",
  "secrets.providers.*.allowlist": "Secret Provider Allowlist",
  "secrets.providers.*.path": "Secret Provider File Path",
  "secrets.providers.*.mode": "Secret Provider File Mode",
  "secrets.providers.*.maxBytes": "Secret Provider Max Bytes",
  "secrets.providers.*.command": "Secret Provider Exec Command",
  "secrets.providers.*.args": "Secret Provider Exec Args",
  "secrets.providers.*.env": "Secret Provider Exec Env",
  "secrets.providers.*.passEnv": "Secret Provider Pass-through Env",
  "secrets.providers.*.timeoutMs": "Secret Provider Timeout (ms)",
  "secrets.providers.*.noOutputTimeoutMs": "Secret Provider No-Output Timeout (ms)",
  "secrets.providers.*.maxOutputBytes": "Secret Provider Max Output Bytes",
  "secrets.providers.*.jsonOnly": "Secret Provider JSON Only",
  "secrets.providers.*.trustedDirs": "Secret Provider Trusted Dirs",
  "secrets.providers.*.allowInsecurePath": "Secret Provider Allow Insecure Path",
  "secrets.providers.*.allowSymlinkCommand": "Secret Provider Allow Symlink Command",
  "secrets.defaults": "Secret Default Providers",
  "secrets.defaults.env": "Default Env Secret Provider",
  "secrets.defaults.file": "Default File Secret Provider",
  "secrets.defaults.exec": "Default Exec Secret Provider",
  "secrets.resolution": "Secret Batch Resolution",
  "secrets.resolution.maxProviderConcurrency": "Secret Resolution Max Concurrency",
  "secrets.resolution.maxRefsPerProvider": "Secret Resolution Max Refs/Provider",
  "secrets.resolution.maxBatchBytes": "Secret Resolution Max Batch Bytes",
  "agents.defaults.thinkingDefault": "Default Thinking Level",
  "agents.defaults.verboseDefault": "Default Verbosity",
  "agents.defaults.elevatedDefault": "Default Elevated Level",
  "agents.defaults.blockStreamingDefault": "Default Block Streaming",
  "agents.defaults.blockStreamingBreak": "Block Streaming Break Point",
  "agents.defaults.systemPromptOverride": "System Prompt Override",
  "agents.defaults.skipBootstrap": "Skip Bootstrap",
  "agents.defaults.userTimezone": "User Timezone",
  "agents.defaults.timeFormat": "Time Format",
  "agents.defaults.contextTokens": "Context Tokens Cap",
  "agents.defaults.timeoutSeconds": "Agent Timeout (sec)",
  "agents.defaults.typingMode": "Typing Mode",
  "agents.defaults.typingIntervalSeconds": "Typing Interval (sec)",
  "agents.defaults.mediaMaxMb": "Max Media Size (MB)",
  "agents.defaults.maxConcurrent": "Max Concurrent Runs",
  "agents.defaults.imageModel": "Image Input Model",
  "agents.defaults.imageGenerationModel": "Image Generation Model",
  "agents.defaults.videoGenerationModel": "Video Generation Model",
  "agents.defaults.musicGenerationModel": "Music Generation Model",
  "agents.defaults.pdfModel": "PDF Model",
  "agents.defaults.llm.idleTimeoutSeconds": "LLM Idle Timeout (sec)",
  "agents.defaults.subagents.maxSpawnDepth": "Subagent Max Spawn Depth",
  "agents.defaults.subagents.maxChildrenPerAgent": "Subagent Max Children/Agent",
  "agents.defaults.subagents.archiveAfterMinutes": "Subagent Archive After (min)",
  "agents.defaults.subagents.allowAgents": "Subagent Allowed Agents",
  "agents.defaults.subagents.requireAgentId": "Subagent Require Agent ID",
  "agents.defaults.subagents.thinking": "Subagent Thinking Level",
  ...
  "tools.exec.backgroundMs": "Exec Background After (ms)",
  "tools.exec.timeoutSec": "Exec Timeout (sec)",
  "tools.exec.cleanupMs": "Exec Session Cleanup (ms)",
  "browser.extraArgs": "Browser Extra Args",
  "logging.maxFileBytes": "Log Max File Bytes",
  "skills.allowBundled": "Allow Bundled Skills",
  "skills.load.extraDirs": "Skill Load Extra Dirs",
  "skills.limits.maxSkillsLoadedPerSource": "Max Skills Per Source",
  "skills.limits.maxSkillsInPrompt": "Max Skills In Prompt",
  "skills.limits.maxSkillsPromptChars": "Max Skills Prompt Chars",
  "skills.limits.maxSkillFileBytes": "Max Skill File Bytes",
  "skills.limits.maxCandidatesPerRoot": "Max Skill Candidates/Root",
  "skills.install.nodeManager": "Skill Install Node Manager",
  "skills.install.preferBrew": "Skill Install Prefer Brew",
  "messages.tts.enabled": "Enable TTS",
  "messages.tts.mode": "TTS Mode",
  "messages.tts.provider": "TTS Provider",
  "messages.tts.auto": "TTS Auto Mode",
  "messages.tts.maxTextLength": "TTS Max Text Length",
  "messages.tts.timeoutMs": "TTS Timeout (ms)",
  "messages.tts.summaryModel": "TTS Summary Model",
  "messages.tts.prefsPath": "TTS Preferences Path",
  "agents.list[].soul.preset": "Agent Soul Preset",
  "gateway.auth.token.id": "Gateway Token SecretRef ID",
  "gateway.auth.token.provider": "Gateway Token SecretRef Provider",
  "gateway.auth.token.source": "Gateway Token SecretRef Source",
  "gateway.auth.password.id": "Gateway Password SecretRef ID",
  "gateway.auth.password.provider": "Gateway Password SecretRef Provider",
  "gateway.auth.password.source": "Gateway Password SecretRef Source",
  "gateway.remote.token.id": "Remote Token SecretRef ID",
  "gateway.remote.token.provider": "Remote Token SecretRef Provider",
  "gateway.remote.token.source": "Remote Token SecretRef Source",
  "gateway.remote.password.id": "Remote Password SecretRef ID",
  "gateway.remote.password.provider": "Remote Password SecretRef Provider",
  "gateway.remote.password.source": "Remote Password SecretRef Source",
  "cron.webhookToken.id": "Webhook Token SecretRef ID",
  "cron.webhookToken.provider": "Webhook Token SecretRef Provider",
  "cron.webhookToken.source": "Webhook Token SecretRef Source",
  "agents.defaults.blockStreamingChunk.breakPreference": "Block Streaming Break Preference",
  "agents.defaults.blockStreamingChunk.maxChars": "Block Streaming Max Chars",
  "agents.defaults.blockStreamingChunk.minChars": "Block Streaming Min Chars",
  "agents.defaults.blockStreamingCoalesce.idleMs": "Block Coalesce Idle (ms)",
  "agents.defaults.blockStreamingCoalesce.maxChars": "Block Coalesce Max Chars",
  "agents.defaults.blockStreamingCoalesce.minChars": "Block Coalesce Min Chars",
  "agents.defaults.backgroundBatch": "Background Batch API",
  "agents.defaults.contextPruning.mode": "Context Pruning Mode",
  "agents.defaults.contextPruning.ttl": "Context Pruning TTL",
  ...
  "agents.defaults.contextPruning.minPrunableToolChars": "Context Pruning Min Tool Chars",
  ...
  "agents.defaults.heartbeat.session": "Heartbeat Session",
  "agents.defaults.heartbeat.to": "Heartbeat Delivery Target",
  "agents.defaults.heartbeat.accountId": "Heartbeat Account ID",
  "agents.defaults.heartbeat.target": "Heartbeat Delivery Channel",
  ...
  "agents.defaults.heartbeat.isolatedSession": "Heartbeat Isolated Session",
  "agents.defaults.heartbeat.includeReasoning": "Heartbeat Include Reasoning",
  "agents.defaults.heartbeat.timeoutSeconds": "Heartbeat Timeout (s)",
  ...
  "agents.defaults.sandbox.scope": "Sandbox Scope",
  "agents.defaults.sandbox.sessionToolsVisibility": "Sandbox Tool Visibility",
  "agents.defaults.sandbox.workspaceAccess": "Sandbox Workspace Access",
  "agents.defaults.sandbox.workspaceRoot": "Sandbox Workspace Root",
  "messages.statusReactions.emojis.thinking": "Thinking Emoji",
  "messages.statusReactions.emojis.tool": "Tool Emoji",
  "messages.statusReactions.emojis.coding": "Coding Emoji",
  "messages.statusReactions.emojis.web": "Web Search Emoji",
  "messages.statusReactions.emojis.done": "Done Emoji",
  "messages.statusReactions.emojis.error": "Error Emoji",
  "messages.statusReactions.emojis.stallSoft": "Soft Stall Emoji",
  "messages.statusReactions.emojis.stallHard": "Hard Stall Emoji",
  "messages.statusReactions.emojis.compacting": "Compacting Emoji",
  "messages.statusReactions.timing.debounceMs": "Status Debounce (ms)",
  "messages.statusReactions.timing.stallSoftMs": "Soft Stall Timeout (ms)",
  "messages.statusReactions.timing.stallHardMs": "Hard Stall Timeout (ms)",
  "messages.statusReactions.timing.doneHoldMs": "Done Hold Duration (ms)",
  "messages.statusReactions.timing.errorHoldMs": "Error Hold Duration (ms)",
  "session.resetByType.direct.mode": "Direct Chat Reset Mode",
  "session.resetByType.direct.atHour": "Direct Chat Reset Hour",
  "session.resetByType.direct.idleMinutes": "Direct Chat Idle Reset (min)",
  "session.resetByType.group.mode": "Group Chat Reset Mode",
  "session.resetByType.group.atHour": "Group Chat Reset Hour",
  "session.resetByType.group.idleMinutes": "Group Chat Idle Reset (min)",
  "session.resetByType.thread.mode": "Thread Chat Reset Mode",
  "session.resetByType.thread.atHour": "Thread Chat Reset Hour",
  "session.resetByType.thread.idleMinutes": "Thread Chat Idle Reset (min)",
  "tools.web.search.apiKey": "Web Search API Key",
  "tools.web.x_search.enabled": "X Search Enabled",
  ...
  "tools.web.x_search.timeoutSeconds": "X Search Timeout (s)",
  "tools.web.x_search.cacheTtlMinutes": "X Search Cache TTL (min)",
  "tools.sandbox.tools.allow": "Sandbox Tool Allow List",
  "tools.sandbox.tools.alsoAllow": "Sandbox Tool Also Allow",
  "tools.sandbox.tools.deny": "Sandbox Tool Deny List",
  "tools.subagents.tools.allow": "Sub-Agent Tool Allow List",
  "tools.subagents.tools.alsoAllow": "Sub-Agent Tool Also Allow",
  "tools.subagents.tools.deny": "Sub-Agent Tool Deny List",
  "tools.sessions_spawn.attachments.enabled": "Spawn Attachments Enabled",
  "tools.sessions_spawn.attachments.maxFileBytes": "Spawn Max File Bytes",
  "tools.sessions_spawn.attachments.maxFiles": "Spawn Max Files",
  "cron.failureAlert.enabled": "Cron Failure Alert Enabled",
  "cron.failureAlert.mode": "Cron Failure Alert Mode",
  "cron.failureAlert.after": "Cron Failure Alert After",
  "cron.failureAlert.cooldownMs": "Cron Failure Alert Cooldown (ms)",
  "cron.failureAlert.accountId": "Cron Failure Alert Account ID",
  "cron.failureDestination.channel": "Cron Failure Channel",
  "cron.failureDestination.to": "Cron Failure Destination",
  "cron.failureDestination.mode": "Cron Failure Delivery Mode",
  "cron.failureDestination.accountId": "Cron Failure Destination Account ID",
  "tools.media.image.baseUrl": "Image Understanding Base URL",
  "tools.media.image.echoFormat": "Image Echo Format",
  "tools.media.image.echoTranscript": "Image Echo Transcript",
  "tools.media.video.baseUrl": "Video Understanding Base URL",
  "tools.media.audio.baseUrl": "Audio Understanding Base URL",
  "agents.defaults.memorySearch.store.fts.tokenizer": "FTS Tokenizer",
};
