...
import type { ConfigFileSnapshot, KaijiBotConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => KaijiBotConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: KaijiBotConfig }): ConfigFileSnapshot {
  return {
