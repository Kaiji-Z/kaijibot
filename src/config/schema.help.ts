...
export const FIELD_HELP: Record<string, string> = {
  ...
  "secrets.providers.*.args": "For exec-source providers: arguments passed to the command.",
  ...
  "agents.defaults.blockStreamingChunk.maxChars":
    "Maximum characters per streamed block chunk before splitting.",
  ...
  "agents.defaults.blockStreamingCoalesce.idleMs":
    "Idle time in ms before flushing coalesced block replies.",
  "agents.defaults.blockStreamingCoalesce.maxChars":
    "Maximum characters to coalesce before flushing.",
  ...
  "agents.defaults.contextPruning.softTrimRatio":
    "Fraction of original content kept during soft trimming (0-1).",
  ...
  "agents.defaults.heartbeat.accountId":
    "Account id override for multi-account heartbeat delivery.",
  "agents.defaults.heartbeat.target":
    'Delivery channel for heartbeat: "last", "none", or a channel id.',
  ...
  "agents.defaults.sandbox.workspaceRoot":
    "Root directory mounted into the sandbox as the workspace.",
  ...
  "messages.statusReactions.emojis.compacting":
    "Emoji for context compaction state (default: \u{1F9F9}).",
  ...
  "messages.statusReactions.timing.stallSoftMs":
    "Soft stall warning timeout in ms (default: 25000).",
  "messages.statusReactions.timing.stallHardMs":
    "Hard stall warning timeout in ms (default: 60000).",
  ...
  "tools.web.x_search.inlineCitations":
    "Keep inline citations in xAI response payload (default: true).",
  ...
  "tools.sessions_spawn.attachments.enabled":
    "Enable file attachments in sub-agent spawn requests.",
  "tools.sessions_spawn.attachments.maxFileBytes":
    "Maximum file size in bytes for spawn attachments.",
