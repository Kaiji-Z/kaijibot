...
vi.mock("../commands/commands.js", () => ({
  resolveNativeCommandsEnabled: () => true,
  resolveNativeSkillsEnabled: () => true,
      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/kaijibot.plugin.json",
        ...
        ...[
          ...
          source: "test",
          manifestPath: `/tmp/plugins/${id}/kaijibot.plugin.json`,
