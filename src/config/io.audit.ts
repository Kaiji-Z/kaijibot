...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.KAIJIBOT_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.KAIJIBOT_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.KAIJIBOT_WATCH_COMMAND),
