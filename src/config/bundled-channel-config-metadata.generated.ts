...
export const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = [
  ...
  },
  {
    ...
    uiHints: {
      ...
      "eventQueue.listenerTimeout": {
        ...
        help: "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Default is 120000 in KaijiBot; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
      },
  ...
  },
  {
    ...
    uiHints: {
      "": {
        label: "IRC",
        help: "IRC channel provider configuration and compatibility settings for classic IRC transport workflows. Use this section when bridging legacy chat infrastructure into KaijiBot.",
      },
      dmPolicy: {
        label: "IRC DM Policy",
  ...
  },
  {
    ...
    label: "QA Channel",
    description: "Synthetic Slack-class transport for automated KaijiBot QA scenarios.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
  ...
  },
  {
    ...
    uiHints: {
      ...
      execApprovals: {
        ...
        help: "Slack-native exec approval routing and approver authorization. When unset, KaijiBot auto-enables DM-first native approvals if approvers can be resolved for this workspace account.",
      },
      ...
      "execApprovals.approvers": {
        ...
        help: "Slack user IDs allowed to approve exec requests for this workspace account. Use Slack user IDs or user targets such as `U123`, `user:U123`, or `<@U123>`. If you leave this unset, KaijiBot falls back to commands.ownerAllowFrom when possible.",
      },
  ...
  },
  {
    ...
    label: "Synology Chat",
    description: "Connect your Synology NAS Chat to KaijiBot with full agent capabilities.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
