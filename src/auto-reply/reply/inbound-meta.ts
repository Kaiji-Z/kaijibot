...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "kaijibot.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by KaijiBot out-of-band. Treat it as authoritative metadata about the current message context.",
