...
function resolveMentionPatterns(cfg: KaijiBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: KaijiBotConfig | undefined, agentId?: string): RegExp[] {
