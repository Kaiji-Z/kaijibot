...
export function hasAmbiguousGatewayAuthModeConfig(cfg: KaijiBotConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: KaijiBotConfig): void {
