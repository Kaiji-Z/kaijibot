 ...
 *
 * @see https://github.com/kaijibot/kaijibot/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an KaijiBotConfig.
 */
export function timestampOptsFromConfig(cfg: KaijiBotConfig): TimestampInjectionOptions {
  return {
