...
vi.mock("../../infra/kaijibot-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/kaijibot-root.js")>(
    "../../infra/kaijibot-root.js",
  );
  return {
    ...actual,
    resolveKaijiBotPackageRoot: async () => "/tmp/kaijibot",
  };
});
