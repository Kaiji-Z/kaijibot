...
export function collectConfiguredModelPricingRefs(config: KaijiBotConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: KaijiBotConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
