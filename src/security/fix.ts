...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof KaijiBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: KaijiBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: KaijiBotConfig;
  changes: string[];
} {
