/**
 * Shared text similarity utilities: CJK-aware tokenizer + Jaccard similarity.
 *
 * This is the canonical implementation used across the cognitive layer
 * (correction store, evolution lifecycle, scheduler gate).
 * The memory-core extension has its own copy in mmr.ts with identical logic;
 ...
 * Extracts alphanumeric tokens, CJK-family character unigrams,
