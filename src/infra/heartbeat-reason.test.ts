...
describe("heartbeat-reason", () => {
  ...
  it.each([
    ...
    { value: "  hook:wake  ", expected: "hook" },
    { value: "cognitive-insight", expected: "wake" },
    { value: "cognitive-insight:scan", expected: "wake" },
    { value: "cognitive-evolution", expected: "wake" },
    { value: "cognitive-evolution:suggest", expected: "wake" },
  ...
  it.each([
    ...
    { value: "cognitive-insight", expected: true },
    { value: "cognitive-insight:scan", expected: true },
    { value: "cognitive-evolution", expected: true },
    { value: "cognitive-evolution:suggest", expected: true },
