...
type AgentDefaultsModel = NonNullable<NonNullable<KaijiBotConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<KaijiBotConfig["agents"]>["defaults"]>["models"];
