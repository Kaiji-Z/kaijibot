...
vi.mock("kaijibot/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("kaijibot/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
