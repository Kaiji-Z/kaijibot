...
function getDescribedActions(cfg: KaijiBotConfig, accountId?: string): string[] {
...
async function expectLegacyFeishuCardPayloadRejected(cfg: KaijiBotConfig, card: unknown) {
  await expect(
