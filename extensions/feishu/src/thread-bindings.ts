...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "kaijibot/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("kaijibot.feishuThreadBindingsState");
