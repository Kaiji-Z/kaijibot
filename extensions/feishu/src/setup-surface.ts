...
function getScopedFeishuConfig(cfg: KaijiBotConfig, accountId: string): ScopedFeishuConfig {
...
function isFeishuConfigured(cfg: KaijiBotConfig, accountId?: string | null): boolean {
