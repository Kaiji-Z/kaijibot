...
import {
  ...
  sessionPathForFile,
} from "kaijibot/plugin-sdk/memory-core-host-engine-qmd";
...
const LIGHT_SLEEP_EVENT_TEXT = "__kaijibot_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__kaijibot_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- kaijibot:dreaming:light:start -->",
    endMarker: "<!-- kaijibot:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- kaijibot:dreaming:rem:start -->",
    endMarker: "<!-- kaijibot:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: KaijiBotPluginApi): void {
