...
import { resolveGlobalMap } from "kaijibot/plugin-sdk/global-singleton";
import { createAsyncLock } from "kaijibot/plugin-sdk/infra-runtime";
import { resolveStateDir } from "kaijibot/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- kaijibot:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- kaijibot:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "kaijibot:dreaming:backfill-entry";
