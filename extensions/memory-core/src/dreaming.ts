import { peekSystemEventEntries } from "kaijibot/plugin-sdk/infra-runtime";
import type { KaijiBotConfig, KaijiBotPluginApi } from "kaijibot/plugin-sdk/memory-core";
import {
...
const DREAMING_SYSTEM_EVENT_TEXT = "__kaijibot_memory_core_short_term_promotion_dream__";
...
function resolveStartupConfigFromEvent(event: unknown, fallback: KaijiBotConfig): KaijiBotConfig {
  ...
  return startupCfg as KaijiBotConfig;
}
...
export function registerShortTermPromotionDreaming(api: KaijiBotPluginApi): void {
