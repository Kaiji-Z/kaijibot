...
import { checkQmdBinaryAvailability } from "kaijibot/plugin-sdk/memory-core-host-engine-qmd";
import {
...
const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("kaijibot.memorySearchManagerCache");
