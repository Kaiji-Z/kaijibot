...
const GENERATED_START = "<!-- kaijibot:wiki:generated:start -->";
const GENERATED_END = "<!-- kaijibot:wiki:generated:end -->";
const HUMAN_START = "<!-- kaijibot:human:start -->";
const HUMAN_END = "<!-- kaijibot:human:end -->";
