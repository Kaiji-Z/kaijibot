...
export function applyOpencodeZenProviderConfig(cfg: KaijiBotConfig): KaijiBotConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: KaijiBotConfig): KaijiBotConfig {
