...
import { findCatalogTemplate } from "kaijibot/plugin-sdk/provider-catalog-shared";
import {
...
export function resolveConfiguredOpenAIBaseUrl(cfg: KaijiBotConfig | undefined): string {
