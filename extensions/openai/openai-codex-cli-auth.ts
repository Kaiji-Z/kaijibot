...
import type { AuthProfileStore, OAuthCredential } from "kaijibot/plugin-sdk/provider-auth";
import { resolveRequiredHomeDir } from "kaijibot/plugin-sdk/provider-auth";
import {
