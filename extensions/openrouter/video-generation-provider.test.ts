...
vi.mock("kaijibot/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("kaijibot/plugin-sdk/provider-http")>(
    "kaijibot/plugin-sdk/provider-http",
  );
  return {
    ...actual,
