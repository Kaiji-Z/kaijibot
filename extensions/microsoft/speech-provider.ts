...
import { isVoiceCompatibleAudio } from "kaijibot/plugin-sdk/media-runtime";
import {
  captureHttpExchange,
...
import type {
  ...
  SpeechVoiceOption,
} from "kaijibot/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "kaijibot/plugin-sdk/speech";
