...
import type { TelegramActionConfig } from "kaijibot/plugin-sdk/config-runtime";
import { readStringValue } from "kaijibot/plugin-sdk/text-runtime";
import { extractToolSend } from "kaijibot/plugin-sdk/tool-send";
import {
