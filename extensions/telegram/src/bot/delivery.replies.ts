...
import type { ReplyToMode } from "kaijibot/plugin-sdk/config-runtime";
import type { MarkdownTableMode } from "kaijibot/plugin-sdk/config-runtime";
import { fireAndForgetHook } from "kaijibot/plugin-sdk/hook-runtime";
import { createInternalHookEvent, triggerInternalHook } from "kaijibot/plugin-sdk/hook-runtime";
import {
  buildCanonicalSentMessageHookContext,
  toInternalMessageSentContext,
  toPluginMessageContext,
  toPluginMessageSentEvent,
} from "kaijibot/plugin-sdk/hook-runtime";
import { buildOutboundMediaLoadOptions } from "kaijibot/plugin-sdk/media-runtime";
import { isGifMedia, kindFromMime } from "kaijibot/plugin-sdk/media-runtime";
import {
  createOutboundPayloadPlan,
  projectOutboundPayloadPlanForDelivery,
} from "kaijibot/plugin-sdk/outbound-runtime";
import { getGlobalHookRunner } from "kaijibot/plugin-sdk/plugin-runtime";
import type { ReplyPayload } from "kaijibot/plugin-sdk/reply-runtime";
import { chunkMarkdownTextWithMode, type ChunkMode } from "kaijibot/plugin-sdk/reply-runtime";
import type { RuntimeEnv } from "kaijibot/plugin-sdk/runtime-env";
import { danger, logVerbose } from "kaijibot/plugin-sdk/runtime-env";
...
import { loadWebMedia } from "kaijibot/plugin-sdk/web-media";
...
export async function deliverReplies(params: {
  ...
  cfg?: import("kaijibot/plugin-sdk/config-runtime").KaijiBotConfig;
  chatId: string;
  accountId?: string;
  sessionKeyForInternalHooks?: string;
