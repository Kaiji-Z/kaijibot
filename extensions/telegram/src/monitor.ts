...
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "kaijibot/plugin-sdk/approval-handler-adapter-runtime";
import { registerChannelRuntimeContext } from "kaijibot/plugin-sdk/channel-runtime-context";
import { resolveAgentMaxConcurrent } from "kaijibot/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "kaijibot/plugin-sdk/runtime-env";
import { registerUnhandledRejectionHandler } from "kaijibot/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: KaijiBotConfig): RunOptions<unknown> {
  return {
    sink: {
