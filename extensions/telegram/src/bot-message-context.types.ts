...
import type { HistoryEntry } from "kaijibot/plugin-sdk/reply-history";
...
export type BuildTelegramMessageContextParams = {
  ...
  upsertPairingRequest?: typeof import("kaijibot/plugin-sdk/conversation-runtime").upsertChannelPairingRequest;
