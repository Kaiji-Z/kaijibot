...
import { clearHistoryEntriesIfEnabled } from "kaijibot/plugin-sdk/reply-history";
import { resolveSendableOutboundReplyParts } from "kaijibot/plugin-sdk/reply-payload";
import { isAbortRequestText, type ReplyPayload } from "kaijibot/plugin-sdk/reply-runtime";
...
import {
  ...
  logVerbose,
  sleepWithAbort,
} from "kaijibot/plugin-sdk/runtime-env";
...
async function resolveStickerVisionSupport(cfg: KaijiBotConfig, agentId: string) {
  try {
