...
type ResolveConfiguredBindingRouteFn =
  typeof import("kaijibot/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("kaijibot/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("kaijibot/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("kaijibot/plugin-sdk/conversation-runtime")>(
    "kaijibot/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/kaijibot-sessions.json");
