...
vi.mock("kaijibot/plugin-sdk/runtime-env", async () => {
  const actual = await vi.importActual<typeof import("kaijibot/plugin-sdk/runtime-env")>(
    "kaijibot/plugin-sdk/runtime-env",
  );
  return {
    ...actual,
    computeBackoff,
