import type { ChannelSetupAdapter } from "kaijibot/plugin-sdk/setup-runtime";
import {
  ...
  type KaijiBotConfig,
  type WizardPrompter,
} from "kaijibot/plugin-sdk/setup-runtime";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://github.com/Kaiji-Z/kaijibot",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("kaijibot logs --follow")}\` (safest)`,
