...
vi.mock("kaijibot/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("kaijibot/plugin-sdk/reply-dispatch-runtime", () => ({
  dispatchReplyWithBufferedBlockDispatcher:
    replyPipelineMocks.dispatchReplyWithBufferedBlockDispatcher,
}));
vi.mock("kaijibot/plugin-sdk/conversation-runtime", () => ({
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as KaijiBotConfig)),
    readChannelAllowFromStore: vi.fn(async () => []),
    dispatchReplyWithBufferedBlockDispatcher:
      replyPipelineMocks.dispatchReplyWithBufferedBlockDispatcher,
    getPluginCommandSpecs: pluginCommandMocks.getPluginCommandSpecs,
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as KaijiBotConfig),
