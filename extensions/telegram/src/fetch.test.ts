...
describe("resolveTelegramFetch", () => {
  ...
  it("uses the KaijiBot debug proxy URL when no explicit proxy fetch is provided", async () => {
  ...
  it("keeps resolver-scoped transport policy for KaijiBot proxy fetches", async () => {
