import { resolveApiKeyForProvider } from "kaijibot/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "kaijibot/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
} from "kaijibot/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "kaijibot/plugin-sdk/agent-runtime";
import type { KaijiBotConfig } from "kaijibot/plugin-sdk/config-runtime";
import { resolveAutoImageModel } from "kaijibot/plugin-sdk/media-runtime";
import {
