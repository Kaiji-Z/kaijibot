...
import {
  ...
  type KaijiBotConfig,
} from "kaijibot/plugin-sdk/account-core";
import type {
  TelegramAccountConfig,
  TelegramActionConfig,
} from "kaijibot/plugin-sdk/config-runtime";
import { formatSetExplicitDefaultInstruction } from "kaijibot/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "kaijibot/plugin-sdk/runtime-env";
import { normalizeOptionalString } from "kaijibot/plugin-sdk/string-coerce-runtime";
...
export function listEnabledTelegramAccounts(cfg: KaijiBotConfig): ResolvedTelegramAccount[] {
