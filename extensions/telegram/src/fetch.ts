...
import type { TelegramNetworkConfig } from "kaijibot/plugin-sdk/config-runtime";
...
} from "kaijibot/plugin-sdk/fetch-runtime";
import {
  captureHttpExchange,
  resolveEffectiveDebugProxyUrl,
} from "kaijibot/plugin-sdk/proxy-capture";
import { resolveRequestUrl } from "kaijibot/plugin-sdk/request-url";
...
// fix for the leak observed in kaijibot#68128 is the transport lifecycle that
