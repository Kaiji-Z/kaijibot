...
const TEST_CACHE_DIR = "/tmp/kaijibot-test-sticker-cache/telegram";
const TEST_CACHE_FILE = path.join(TEST_CACHE_DIR, "sticker-cache.json");

describe("sticker-cache", () => {
  beforeEach(() => {
    process.env.OPENCLAW_STATE_DIR = "/tmp/kaijibot-test-sticker-cache";
    fs.rmSync("/tmp/kaijibot-test-sticker-cache", { recursive: true, force: true });
