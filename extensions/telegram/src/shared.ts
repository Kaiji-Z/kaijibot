...
import { createChannelPluginBase, type ChannelPlugin } from "kaijibot/plugin-sdk/channel-core";
import { getChatChannelMeta } from "kaijibot/plugin-sdk/channel-plugin-common";
import type { KaijiBotConfig } from "kaijibot/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "kaijibot/plugin-sdk/routing";
 ...
 */
function isBlockedByMultiBotGuard(cfg: KaijiBotConfig, accountId: string): boolean {
