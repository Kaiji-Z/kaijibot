...
import type { ChannelLegacyStateMigrationPlan } from "kaijibot/plugin-sdk/channel-contract";
import { resolveChannelAllowFromPath } from "kaijibot/plugin-sdk/channel-pairing-paths";
