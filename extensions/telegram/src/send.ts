...
import { isDiagnosticFlagEnabled } from "kaijibot/plugin-sdk/diagnostic-runtime";
import { formatUncaughtError } from "kaijibot/plugin-sdk/error-runtime";
import { recordChannelActivity } from "kaijibot/plugin-sdk/infra-runtime";
import { createTelegramRetryRunner, type RetryConfig } from "kaijibot/plugin-sdk/retry-runtime";
import { createSubsystemLogger, logVerbose } from "kaijibot/plugin-sdk/runtime-env";
import { formatErrorMessage } from "kaijibot/plugin-sdk/ssrf-runtime";
import { normalizeOptionalString, redactSensitiveText } from "kaijibot/plugin-sdk/text-runtime";
...
function createTelegramHttpLogger(cfg: KaijiBotConfig) {
