import { resolveAccountWithDefaultFallback } from "kaijibot/plugin-sdk/account-core";
...
import { coerceSecretRef } from "kaijibot/plugin-sdk/config-runtime";
...
function inspectTokenValue(params: { cfg: KaijiBotConfig; value: unknown }): {
  token: string;
