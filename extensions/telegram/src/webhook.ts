...
import { safeEqualSecret } from "kaijibot/plugin-sdk/browser-security-runtime";
import type { KaijiBotConfig } from "kaijibot/plugin-sdk/config-runtime";
import { isDiagnosticsEnabled } from "kaijibot/plugin-sdk/diagnostic-runtime";
import type { RuntimeEnv } from "kaijibot/plugin-sdk/runtime-env";
import { defaultRuntime } from "kaijibot/plugin-sdk/runtime-env";
...
import { readJsonBodyWithLimit } from "kaijibot/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: KaijiBotConfig): string {
