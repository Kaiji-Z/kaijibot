...
import { resolveChannelStreamingBlockEnabled } from "kaijibot/plugin-sdk/channel-streaming";
import {
  resolveCommandAuthorization,
  resolveCommandAuthorizedFromAuthorizers,
  resolveNativeCommandSessionTargets,
} from "kaijibot/plugin-sdk/command-auth-native";
import {
...
import type { ChannelGroupPolicy } from "kaijibot/plugin-sdk/config-runtime";
import type {
  ReplyToMode,
...
import { resolveMarkdownTableMode } from "kaijibot/plugin-sdk/markdown-table-runtime";
import { resolveAgentRoute } from "kaijibot/plugin-sdk/routing";
import { getRuntimeConfigSnapshot } from "kaijibot/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose } from "kaijibot/plugin-sdk/runtime-env";
import { getChildLogger } from "kaijibot/plugin-sdk/runtime-env";
...
type TelegramChunkMode = ReturnType<
  typeof import("kaijibot/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("kaijibot/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): KaijiBotConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: KaijiBotConfig): TelegramAccountConfig => {
    try {
