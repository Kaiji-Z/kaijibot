import { DEFAULT_ACCOUNT_ID } from "kaijibot/plugin-sdk/account-id";
import {
  buildDmGroupAccountAllowlistAdapter,
  createNestedAllowlistOverrideResolver,
} from "kaijibot/plugin-sdk/allowlist-config-edit";
import type { ChannelMessageActionAdapter } from "kaijibot/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "kaijibot/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "kaijibot/plugin-sdk/channel-pairing";
import { attachChannelToResult } from "kaijibot/plugin-sdk/channel-send-result";
import {
...
import { createChannelDirectoryAdapter } from "kaijibot/plugin-sdk/directory-runtime";
import { formatErrorMessage } from "kaijibot/plugin-sdk/error-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "kaijibot/plugin-sdk/outbound-runtime";
import { type RoutePeer } from "kaijibot/plugin-sdk/routing";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as KaijiBotConfig;
