...
- **`extensions/`** — bundled plugins. Ground-truth categories as of the current tree:
  ...
  - **Core/media/memory/other**: browser, memory-core, memory-lancedb, knowledge-wiki, speech-core, talk-voice, media-understanding-core, image-generation-core, diffs, llm-task, webhooks, kindle-portal, openshell, device-pair
