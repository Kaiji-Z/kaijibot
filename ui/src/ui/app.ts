...
declare global {
  interface Window {
    __KAIJIBOT_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
export class KaijiBotApp extends LitElement {
...
if (!customElements.get("kaijibot-app")) {
  customElements.define("kaijibot-app", KaijiBotApp);
}
