...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.kaijibot/kaijibot.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde kaijibot dashboard --no-open en tu escritorio.",
    },
    insecure: {
