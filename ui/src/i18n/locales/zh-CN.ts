...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      hint: "此设备需要网关主机的配对批准。",
      mobileHint:
        "在手机上？从桌面运行 kaijibot dashboard --no-open 复制完整 URL（包括 #token=...）。",
    },
    insecure: {
  ...
  settings: {
    ...
    noSettingsInSection: "此分区下没有设置项",
    hideValue: "隐藏值",
    revealValue: "显示值",
    disableStreamToReveal: "禁用流模式后可显示值",
    ...
    sections: {
      ...
      updates: "更新",
      updatesDesc: "自动更新设置和发布通道",
      agents: "代理",
      agentsDesc: "代理配置、模型和身份",
      auth: "认证",
      authDesc: "API 密钥和认证配置",
      channels: "频道",
      ...
      pluginsDesc: "插件管理和扩展",
      diagnostics: "诊断",
      diagnosticsDesc: "遥测、OpenTelemetry 和缓存追踪设置",
      cli: "CLI",
      cliDesc: "CLI 横幅和启动行为",
      secrets: "密钥",
      secretsDesc: "密钥提供商配置",
      acp: "ACP",
      acpDesc: "Agent Communication Protocol 运行时和流式设置",
      mcp: "MCP",
      mcpDesc: "Model Context Protocol 服务器定义",
    },
  },
};
