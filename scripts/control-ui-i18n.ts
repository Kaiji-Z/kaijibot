...
const ENV_PROVIDER = "KAIJIBOT_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "KAIJIBOT_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "KAIJIBOT_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "KAIJIBOT_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "KAIJIBOT_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "KAIJIBOT_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "KAIJIBOT_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "KAIJIBOT_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "KaijiBot", target: "KaijiBot" },
